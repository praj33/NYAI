...
- Name: gravitas.spec.ts >> 2. Recommendation Gatekeeper Test - State Accuracy >> INFORM state: should render decision content
- Location: e2e\gravitas.spec.ts:132:7
...
Call log:
  - waiting for getByRole('button', { name: 'Legal Decisions' })
