...
| [`Evidence_Model.md`](./Evidence_Model.md) | `EvidencePackage` dataclasses, field mapping, complete JSON example |
...
| [`Migration_Guide.md`](./Migration_Guide.md) | L1/L2 migration, before/after JSONL vs EvidencePackage examples |
| [`Future_Extensibility.md`](./Future_Extensibility.md) | Redis, S3, versioning, Governance Console, Replay Center paths |
